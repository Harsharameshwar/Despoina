...
const Consumption = () => {
  ...
  if(currentPath==="/consumption/hourlyenergy"){
    navigate(`${currentPath}/generatepdf`)
  }
  else if(currentPath==="/consumption/fuelconsumption"){
    navigate(`${currentPath}/generatepdf`)
  }
  else if(currentPath==="/consumption/indiapowerreport"){
    navigate(`${currentPath}/generatepdf`)
  }
  else if(currentPath==="/consumption/renewable"){
    navigate(`${currentPath}/generatepdf`)
  }
  }
