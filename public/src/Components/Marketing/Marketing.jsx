...
const Marketing = () => {
  ...
  function handlenavigate() {
    ...
    if (currentPath === "/marketing/advertising") {
      navigate(`${currentPath}/generatepdf`);
    } else if (currentPath === "/marketing/customersegment") {
      navigate(`${currentPath}/generatepdf`);
    } else if (currentPath === "/marketing/fbanalysis") {
      navigate(`${currentPath}/generatepdf`);
    } else if (currentPath === "/marketing/ibmdataanalysis") {
      navigate(`${currentPath}/generatepdf`);
    }
  }
